                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: const [
                            _IngredientChip(icon: '🍚', label: 'Rice'),
                            SizedBox(width: 8),
                            _IngredientChip(icon: '🍗', label: 'Chicken'),
                            SizedBox(width: 8),
                            _IngredientChip(icon: '🥬', label: 'Broccoli'),
                          ],
                        ),
                        const SizedBox(height: 24),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: const [
                            _IngredientChip(icon: '🍚', label: '밥'),
                            SizedBox(width: 8),
                            _IngredientChip(icon: '🍗', label: '닭고기'),
                            SizedBox(width: 8),
