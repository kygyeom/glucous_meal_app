...
//     final n = Map<String, double>.from(
//       (j['nutrients'] as Map).map(
...
//
//   // ✅ 여기부터가 핵심: 클래스 "안"의 정적 메서드로 작성
//   static Future<FoodDetail> fetchFoodDetail(
//     String foodId, {
//     Duration timeout = const Duration(seconds: 8),
//   }) async {
//     // 캐시 히트면 바로 반환
//     final hit = _foodDetailCache[foodId];
...
//     }
//
//     // bodyBytes -> utf8.decode 로 안전 파싱
//     final data =
//         json.decode(utf8.decode(resp.bodyBytes)) as Map<String, dynamic>;
//     final detail = FoodDetail.fromJson(data);
//
//     _foodDetailCache[foodId] = detail; // 캐시 저장(선택)
//     return detail;
//   }
//
//   // ✅ 새 메서드: 이름+ID를 함께 반환 (최적화 유지)
